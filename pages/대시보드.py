...
# 데이터 로드
광고 = pd.read_csv('/mount/src/new-store-feasibility-analysis/streamlit/data/광고.csv')
df = pd.read_csv('/mount/src/new-store-feasibility-analysis/streamlit/data/날짜별_가게별_카테모리매출합.csv')
